...
(function () {
  ...
  if (langBtn) {
    ...
    const htmlNodes = document.querySelectorAll('[data-i18n-html="true"]');
    ...
    function applyLang(lang) {
      ...
      /* ARIA label nodes */
      const ariaNodes = document.querySelectorAll("[data-aria-en][data-aria-ja]");
    ...
    langBtn.addEventListener("click", function () {
      const current = langBtn.getAttribute("data-current-lang");
    ...
    let saved;
    try {
      saved = localStorage.getItem("ellimia_lang");
    } catch (e) {
      saved = null;
    }
    if (saved === "en") {
